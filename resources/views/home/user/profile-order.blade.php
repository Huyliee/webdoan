                            ...
                            @foreach($order as $items)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                               <p class="alert alert-danger" style="width:130px;text-align:center"> Chưa xác nhận</p>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="/home/user/profile_order_detail/{{$items->madonhang}}" class="btn btn-primary">Xem</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
